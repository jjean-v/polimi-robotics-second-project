...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('initial_x', default_value='2.0', description='Initial robot x in the map frame.'),
        DeclareLaunchArgument('initial_y', default_value='2.0', description='Initial robot y in the map frame.'),
